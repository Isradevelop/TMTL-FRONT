...
export const ClientCard = ({ client, setCardIsChange, cardIsChange }) => {
    ...
    <>
      {
        ...
        <div
          ...
          style={{ width: '18rem' }}
        >
          <div className="card-body" style={{ backgroundColor: (clientState.isActive) ? 'rgb(182, 247, 225)' : 'rgb(248, 197, 182)' }}>
            {
